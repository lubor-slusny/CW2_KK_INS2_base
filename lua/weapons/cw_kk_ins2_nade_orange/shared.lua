...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {		
		...
		["orange"] = {model = "models/props/cs_italy/orange.mdl", pos = Vector(0.3757, -0.1201, 1.0064), angle = Angle(0, 90, 20), size = Vector(0.5001, 0.5001, 0.5001), bone = "Weapon", hideVM = true, active = true},
	}
