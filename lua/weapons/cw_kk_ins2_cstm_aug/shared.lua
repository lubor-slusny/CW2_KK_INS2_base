...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/cw_kk_ins2_cstm_aug")

	SWEP.Shell = "KK_INS2_556x45"

	SWEP.AttachmentModelsVM = {
		["handguardStandard"] = {model = "models/weapons/upgrades/a_standard_aug.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/a_woodgrips_aug.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-2.0095, -2, 0.302)
...
SWEP.Animations = {
	...
	foregrip_idle_aim = "foregrip_holster",
...
SWEP.ViewModel		= "models/weapons/v_cw_kk_ins2_cstm_aug.mdl"
