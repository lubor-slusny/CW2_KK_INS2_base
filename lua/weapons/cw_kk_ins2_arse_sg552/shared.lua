...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_sg552")
...
SWEP.ViewModel		= "models/weapons/sg552/v_sg552.mdl"
SWEP.WorldModel		= "models/weapons/sg552/w_sg552.mdl"
