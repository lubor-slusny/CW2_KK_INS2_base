...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_mk2")
...
SWEP.ViewModel		= "models/weapons/cw_kk_doi/v_mk2.mdl"
SWEP.WorldModel		= "models/weapons/w_mk2.mdl"
