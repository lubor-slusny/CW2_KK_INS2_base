...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {/*
		...
		["kk_ins2_ww2_knife"] = {model = "models/weapons/upgrades/a_smle_bayonet_p07.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_scope_enfield"] = {model = "models/weapons/upgrades/a_optic_smle_4x.mdl", rLight = true, pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_gl_enfield"] = {model = "models/weapons/upgrades/a_smle_riflegrenade.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_ww2_sling"] = {model = "models/weapons/upgrades/a_sling_enfield.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	}
...
SWEP.ViewModel		= "models/weapons/cw_kk_doi_ww1/v_smle_ww1.mdl"
