...
if CLIENT then
	...
	SWEP.PrintName = "M34 WP Grenade"

	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_nam_m34")
...
SWEP.ViewModel		= "models/weapons/v_nam_m34.mdl"
SWEP.WorldModel		= "models/weapons/w_nam_m34.mdl"
