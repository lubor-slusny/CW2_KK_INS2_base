...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {/*
		...
		["kk_ins2_ww2_knife"] = {model = "models/weapons/upgrades/a_gew98_bayonet.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_gl_ggg"] = {model = "models/weapons/upgrades/a_gew98_riflegrenade.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_scope_zf4"] = {model = "models/weapons/upgrades/a_optic_gew98_4x.mdl", rLight = true, pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_ww2_sling"] = {model = "models/weapons/upgrades/a_sling_k98.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		-- ["kk_ins2_ww2_stripper"] = {model = "models/weapons/upgrades/a_magazine_trench_g98.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_ww2_stripper"] = {model = "models/weapons/upgrades/a_kar98k_stripper_clip.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	}
	...
	SWEP.IronsightPos = Vector(-1.9961, -4, 1.9966)
	SWEP.IronsightAng = Vector(0.2342, 0.0109, 0)

	SWEP.KKINS2ScopeZF4Pos = Vector(-1.9767, -4, 1.0924)
...
SWEP.Animations = {
	...
	base_reload_stripper_1 = "base_reload_empty_clip",
	base_reload_stripper_1_empty = "base_reload_empty_clip",
	...
	gl_off_reload_stripper_1 = "base_reload_empty_clip",
	gl_off_reload_stripper_1_empty = "base_reload_empty_clip",
	...
	gl_off_idle = "base_holster",
	gl_off_idle_empty = "iron_idle_empty",
...
SWEP.Category = "CW 2.0 KK INS2 WW1"
...
SWEP.ViewModel		= "models/weapons/cw_kk_doi_ww1/v_gew98_ww1.mdl"
