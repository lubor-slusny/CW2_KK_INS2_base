...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_stiletto")

	SWEP.AttachmentModelsVM = {
		["ani_body"] = {model = "models/weapons/v_stiletto.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, hideVM = true, active = true},
	}
...
SWEP.ViewModel		= "models/weapons/cw_kk_doi_c054/v_stiletto.mdl"
SWEP.WorldModel		= "models/weapons/w_stiletto.mdl"
