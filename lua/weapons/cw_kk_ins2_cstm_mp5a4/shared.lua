...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/cw_kk_ins2_cstm_mp5a4")
...
SWEP.ViewModel		= "models/weapons/v_cw_kk_ins2_cstm_mp5a4.mdl"
SWEP.WorldModel		= "models/weapons/w_cw_kk_ins2_cstm_mp5a4.mdl"
