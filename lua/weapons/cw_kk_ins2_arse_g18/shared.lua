...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_glock18")
...
SWEP.ViewModel		= "models/weapons/glock/v_glock18.mdl"
SWEP.WorldModel		= "models/weapons/glock/w_glock18.mdl"
...
SWEP.Primary.ClipSize		= 17 // 33 ext
