...
if CLIENT then
	...
	SWEP.PrintName = "Enfield CW Base"
...
SWEP.Animations = {
	...
	slash_primary = {"slash_1","slash_2"},
	slash_secondary = {"slash_1","slash_2"},
	draw = "draw",
}
...
SWEP.FireModes = {"auto"}
SWEP.Base = "cw_kk_ins2_base_melee2"
...
SWEP.ViewModel		= "models/weapons/cw_kk_doi/v_garand_bayonet.mdl"
